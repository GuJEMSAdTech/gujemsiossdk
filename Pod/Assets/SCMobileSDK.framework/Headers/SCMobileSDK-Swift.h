...
@class UIView;
@protocol SCMobileSDKDelegate;
@class NSCoder;
@class NSBundle;

SWIFT_CLASS("_TtC11SCMobileSDK21SCMobileSDKController")
@interface SCMobileSDKController : UIViewController
@property (nonatomic, readonly, strong) UIView * _Nullable anchor;
@property (nonatomic, copy) NSString * _Nullable adURL;
@property (nonatomic, weak) id <SCMobileSDKDelegate> _Nullable delegate;
...
@interface SCMobileSDKController (SWIFT_EXTENSION(SCMobileSDK))
- (void)playAd;
- (void)pauseAd;
@end
...
SWIFT_PROTOCOL("_TtP11SCMobileSDK19SCMobileSDKDelegate_")
@protocol SCMobileSDKDelegate
@optional
...
@interface WKWebView (SWIFT_EXTENSION(SCMobileSDK))
@end
